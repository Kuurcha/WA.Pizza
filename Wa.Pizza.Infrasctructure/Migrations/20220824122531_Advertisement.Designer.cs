...
namespace Wa.Pizza.Infrasctructure.Migrations
{
    ...
    [Migration("20220824122531_Advertisement")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adress", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApplicationUserId = "9413b419-17f5-42ff-963d-72fcb468778e"
                        },
                        new
                        {
                            Id = 2,
                            AdressString = "Omega-4",
                            ApplicationUserId = "91cd4e4d-0d07-4a10-8325-bb60c2aa18bb"
                        },
                        new
                        {
                            Id = 3,
                            AdressString = "Terra-4",
                            ApplicationUserId = "8f4f9509-be5a-4dbc-a6a9-0415f9c79f66"
                        });
                });
            ...
            modelBuilder.Entity("ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "9413b419-17f5-42ff-963d-72fcb468778e",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "91f3c469-0fcc-497b-bdae-7b8c035a8db4",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8a64ed01-d3b2-4232-b7b8-41dcde2b4f0b",
                            TwoFactorEnabled = false,
                            UserName = "Test"
                        },
                        new
                        {
                            Id = "91cd4e4d-0d07-4a10-8325-bb60c2aa18bb",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4848fcb8-9a2a-4fdc-8f8d-801b06724741",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "65a2e554-e2b6-4e1c-9a0c-0aa78f95b6a4",
                            TwoFactorEnabled = false,
                            UserName = "Test1"
                        },
                        new
                        {
                            Id = "8f4f9509-be5a-4dbc-a6a9-0415f9c79f66",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "07c507ba-449d-4315-acc4-205f5e708a3b",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "7af95766-f8c9-467c-ab69-ac6d7d31eb43",
                            TwoFactorEnabled = false,
                            UserName = "Test2"
                        });
                });
            ...
            modelBuilder.Entity("Wa.Pizza.Core.Model.Advertisement.Advertisement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AdvertisementClientId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RedicrectURL")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.HasIndex("AdvertisementClientId");

                    b.ToTable("Advertisements");
                });

            modelBuilder.Entity("Wa.Pizza.Core.Model.Advertisement.AdvertisementClient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AdvertisementClients");
                });
            ...
            modelBuilder.Entity("Wa.Pizza.Core.Model.Advertisement.Advertisement", b =>
                {
                    b.HasOne("Wa.Pizza.Core.Model.Advertisement.AdvertisementClient", "AdvertisementClient")
                        .WithMany("Advertisements")
                        .HasForeignKey("AdvertisementClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AdvertisementClient");
                });
